...
- Other languages: Dart, shell, C, Elixir, Scheme (in order of familiarity).
...
- Backend service development in JavaScript, including building APIs, working with databases (Firestore, Redis, SQL), and writing web crawlers.
...
- Comfortable with CLI tools and able to write shell scripts.
